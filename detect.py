...
mixer.init()
alarm_sound = mixer.Sound(r"C:\Users\M.SRIMANREDDY\Downloads\mixkit-vintage-warning-alarm-990.wav")
# this xml files are used to detect face , left eye , and right eye of a person.
face_detection = cv2.CascadeClassifier(r"C:\Users\M.SRIMANREDDY\Downloads\haarcascade_frontalface_alt.xml")
left_eye_detection = cv2.CascadeClassifier(r"C:\Users\M.SRIMANREDDY\Downloads\haarcascade_lefteye_2splits.xml")
right_eye_detection = cv2.CascadeClassifier(r"C:\Users\M.SRIMANREDDY\Downloads\haarcascade_righteye_2splits.xml")
